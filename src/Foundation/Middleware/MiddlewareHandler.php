...
namespace Cool\Foundation\Middleware;

use Cool\Contracts\Foundation\MiddlewareInterface;

/**
 * Class MiddlewareHandler
 * @package Cool\Foundation\Middleware
 */
class MiddlewareHandler
{
    /**
    ...
    protected static function newInstances(string $namespace, array $middleware)
    {
        ...
        foreach ($middleware as $key => $name) {
            ...
            if (!($object instanceof MiddlewareInterface)) {
                throw new \RuntimeException("{$class} type is not 'Cool\Contracts\Foundation\MiddlewareInterface'");
            }
