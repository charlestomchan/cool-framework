...
use Cool\Support\Arr;
use Cool\Support\Str;
use Cool\Support\Collection;
use Cool\Contracts\Support\Htmlable;
...
if (!function_exists('collect')) {
     ...
     *
     * @param  mixed $value
     * @return \Cool\Support\Collection
     */
...
if (!function_exists('e')) {
     ...
     *
     * @param  \Cool\Contracts\Support\Htmlable|string $value
