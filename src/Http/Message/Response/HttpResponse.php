...
namespace Cool\Http\Message\Response;


use Cool\Contracts\Foundation\ComponentInterface;
use Cool\Contracts\Http\Message\HttpResponseInterface;
use Cool\Http\Message\Response\Base\AbstractHttpResponse;

/**
 * Class HttpResponse
 * @package Cool\Http\Message\Response
 */
